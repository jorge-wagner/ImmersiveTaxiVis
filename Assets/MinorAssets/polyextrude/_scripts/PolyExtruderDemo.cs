...
public class PolyExtruderDemo : MonoBehaviour
{
    ...
    public enum ExampleData { Pentragram, Triangle, Square, Cross, SCB_Gotland };
    ...
    void Start()
    {
        ...
        switch (exampleData)
        {
            case ExampleData.Pentragram:
                polyExtruderGO.name = "Pentragram";
                polyExtruder.createPrism(polyExtruderGO.name, extrusionHeight, MeshDataPentagram, Color.blue, is3D, isUsingBottomMeshIn3D, isUsingCollider);
                break;
    ...
    public static Vector2[] MeshDataPentagram = new Vector2[]
    {
        new Vector2(0.0f, 0.0f),
