...
namespace IATK
{
    ...
    public class View : MonoBehaviour 
    {
        ...
        {
            List<Color> colors = new List<Color>(bigMesh.GetNumberVertices()); // jawfilho

            for (int i = 0; i < bigMesh.GetNumberVertices(); i++)
                colors.Add(color);
        ...
        public float GetMinNormX()
        {
            return bigMesh.SharedMaterial.GetFloat("_MinNormX");
        }
        ...
        public float GetMaxNormX()
        {
            return bigMesh.SharedMaterial.GetFloat("_MaxNormX");
        }
        ...
        public float GetMinNormY()
        {
            return bigMesh.SharedMaterial.GetFloat("_MinNormY");
        }
        ...
        public float GetMaxNormY()
        {
            return bigMesh.SharedMaterial.GetFloat("_MaxNormY");
        }
        ...
        public float GetMinNormZ()
        {
            return bigMesh.SharedMaterial.GetFloat("_MinNormZ");
        }
        ...
        public float GetMaxNormZ()
        {
            return bigMesh.SharedMaterial.GetFloat("_MaxNormZ");
        }
        ...
        {
            return bigMesh.SharedMaterial.GetFloat("_MinX");
        }
        ...
        {
            return bigMesh.SharedMaterial.GetFloat("_MaxX");
        }
        ...
        {
            return bigMesh.SharedMaterial.GetFloat("_MinY");
        }
        ...
        {
            return bigMesh.SharedMaterial.GetFloat("_MaxY");
        }
        ...
        {
            return bigMesh.SharedMaterial.GetFloat("_MinZ");
        }
        ...
        {
            return bigMesh.SharedMaterial.GetFloat("_MaxZ");
        }
