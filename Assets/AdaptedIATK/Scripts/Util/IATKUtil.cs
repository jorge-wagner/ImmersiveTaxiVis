        ...
        public static Material GetMaterialFromTopology(AbstractVisualisation.GeometryType configuration)
        {
            ...
            switch (configuration)
            {
                ...
                case AbstractVisualisation.GeometryType.Points:
                    ...
                    mt.mainTexture = Resources.Load<Texture2D>("circle-outline-basic1"); // as Texture2D;
                    mt.renderQueue = 3000;
                    return mt;

                case AbstractVisualisation.GeometryType.Points2D:   // modified by jawfilho
                    mt = new Material(Shader.Find("IATK/OutlineDots2D"));
                    mt.mainTexture = Resources.Load<Texture2D>("circle-outline-basic1"); // as Texture2D;
                    mt.renderQueue = 3000;
                    return mt;
                ...
                case AbstractVisualisation.GeometryType.Lines:
                    ...
                    mt = new Material(Shader.Find("Specular"));
                    mt.renderQueue = 3000;
                    return mt;
