Shader "IATK/OutlineDots2DClipped" 
{    Properties
    {
    ...
    SubShader
    {
        Pass
        {
            ...
            CGPROGRAM
                ...
                //#pragma noshadow nodynlightmap noforwardadd // jawfilho
                ...
                float3 _Origin;   // clipped
                float3 _BoxSize;  // clipped
                float3 _BoxRotation; // clipped
