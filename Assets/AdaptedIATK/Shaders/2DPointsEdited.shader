Shader "IATK/OutlineDots2DEdited" 
{    Properties
    {
        ...
        Pass
        {
            ...
            CGPROGRAM
                ...
                void geom(point v2g input[1], inout TriangleStream<g2f> triStream)
                {
                    ...
                    float3 objectUp = unity_WorldToObject[2].xyz;   // modified by jawfilho
                    float3 objectRight = unity_WorldToObject[0].xyz; // modified by jawfilho
                    ...
                    v[0] = float4(input[0].pos + halfS * objectRight - halfS * objectUp, 1.0f); // modified by jawfilho
                    v[1] = float4(input[0].pos + halfS * objectRight + halfS * objectUp, 1.0f); // modified by jawfilho
                    v[2] = float4(input[0].pos - halfS * objectRight - halfS * objectUp, 1.0f); // modified by jawfilho
                    v[3] = float4(input[0].pos - halfS * objectRight + halfS * objectUp, 1.0f); // modified by jawfilho
